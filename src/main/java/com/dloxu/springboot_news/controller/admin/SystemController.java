...
import com.dloxu.springboot_news.service.*;
import com.dloxu.springboot_news.util.CpachaUtil;
...
public class SystemController {
	...
	/**
	 * Description:后台退出注销功能
	 * @author   dloxu
	 * @param
	 * @return
	 * @date 2020/2/29 14:29
	 */
	...
	/**
	 * Description:本系统所有的验证码均采用此方法,用来区别验证码的类型，传入字符串
	 * @author   dloxu
	 * @param
	 * @return
	 * @date 2020/2/29 14:29
