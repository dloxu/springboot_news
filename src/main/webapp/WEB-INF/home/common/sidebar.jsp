	...
	<div class="tab-content">
	  <div role="tabpanel" class="tab-pane contact active" id="notice">
		<h2>文章总数:
		  ...
		  <h2>网站运行:
		  <span id="sitetime">10</span>天</h2>
	  </div>
		<div role="tabpanel" class="tab-pane contact" id="contact">
		  <h2>QQ:
			  <a href="#" target="_blank" rel="nofollow" data-toggle="tooltip" data-placement="bottom" title=""  data-original-title="QQ:1368401225">1368401225</a>
		  </h2>
		  <h2>Email:
		  <a href="#" target="_blank" data-toggle="tooltip" rel="nofollow" data-placement="bottom" title=""  data-original-title="#">xjf19980309@163.com</a></h2>
	  </div>
	</div>
  </div>
		...
		success:function(data){
			if(data.type == 'success'){
				...
				for(var i=0;i<newsList.length;i++){
					...
					li += '<img class="thumb" data-original="../static/home/images/201610181739277776.jpg" src="'+newsList[i].photo+'" alt="'+newsList[i].id+'"  style="display: block;">';
