...
<div class="content">
  <div id="focusslide" class="carousel slide" data-ride="carousel">
	...
	<div class="carousel-inner" role="listbox">
	  ...
	  <a href="#" target="_blank" title="Dlo新闻网站" >
	  <img src="${pageContext.request.contextPath}/static/home/images/side3.jpg" alt="Dlo新闻网站" class="img-responsive"></a>
	  </div>
	  <div class="item">
	  <a href="#" target="_blank" title="专业网站建设" >
	  <img src="${pageContext.request.contextPath}/static/home/images/side4.jpg" alt="专业网站建设" class="img-responsive"></a>
	  </div>
	</div>
