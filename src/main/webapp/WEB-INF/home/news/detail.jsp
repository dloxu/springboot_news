  ...
  <header class="article-header">
	...
	<div class="article-meta"> 
		<span class="item article-meta-time">
	  	...
	  	<span class="item article-meta-source" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="来源：Dlo新闻">
...
<%--				<input name="nickname" id="nickname" class="form-control" size="22" placeholder="您的昵称（必填）" maxlength="15" autocomplete="off" tabindex="1" type="text" value="${}">--%>
			...
			success:function(data){
				if(data.type == 'success'){
					...
					var li = '<li class="comment-content"><span class="comment-f">#' + ($("#comment_list").children('li').length + 1);
					    li += '</span><div class="comment-main"><p><a class="address" href="#" rel="nofollow" target="_blank">'+data.nickname+'</a><span class="time">('+format(data.createTime)+')</span><br>'+$("#comment-textarea").val()+'</p></div></li></ol>';
