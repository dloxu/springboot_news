...
<head>
    ...
    <title>SpringBoot新闻管理系统注册页</title>
...
<div id="particles-js">
    <div class="login" style="display: block;">
        ...
        <div class="login-center clearfix">
            <div class="login-center-img"><img src="${pageContext.request.contextPath}/static/admin/login/images/password.png"></div>
            <div class="login-center-input">
        ...
        <div class="login-center clearfix">
            <div class="login-center-img"><img src="${pageContext.request.contextPath}/static/admin/login/images/password.png"></div>
            <div class="login-center-input">
                <input type="password" name="password" id="passwordAgain" value="" placeholder="请输入您的密码" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请再次输入您的密码&#39;">
                <div class="login-center-input-text">密码</div>
            </div>
        </div>
